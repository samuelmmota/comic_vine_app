...
data class ComicIssue(
    ...
    @SerializedName("character_credits") val characterCredits: List<Character>?, // Characters in the issue
    @SerializedName("characters_died_in") val charactersDiedIn: List<Character>?, // Characters who died in the issue
    ...
    @SerializedName("first_appearance_characters") val firstAppearanceCharacters: List<Character>?, // Characters appearing for the first time
